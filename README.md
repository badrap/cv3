# CE3 - Common Excuse & Evasion Enumeration

**A taxonomy of vendor dismissal patterns for legitimate vulnerability reports**

CE3 enumerates the recurring, named patterns vendors use to deflect, delay, or retaliate against good-faith security disclosures - structured the way CWE enumerates weakness patterns, so researchers and coordinators can cite a specific ID rather than re-litigating the same dynamics from scratch every time.
...
- [The Taxonomy](#the-taxonomy)
  ...
  - [Category A - Compensating-Control Misuse](#category-a---compensating-control-misuse-ce3-001--ce3-010)
  - [Category B - Threat-Model Gaming](#category-b---threat-model-gaming-ce3-011--ce3-019)
  - [Category C - Severity Manipulation / CVSS Gaming](#category-c---severity-manipulation--cvss-gaming-ce3-020--ce3-028)
  - [Category D - "By Design" / Expected Behavior](#category-d---by-design--expected-behavior-ce3-029--ce3-035)
  - [Category E - Asset Dismissal](#category-e---asset-dismissal-ce3-036--ce3-042)
  - [Category F - Process Deflection](#category-f---process-deflection-ce3-043--ce3-053-ce3-079--ce3-082)
  - [Category G - Legal Deflection](#category-g---legal-deflection-ce3-054--ce3-062)
  - [Category H - Shoot-the-Messenger](#category-h---shoot-the-messenger-ce3-063--ce3-069)
  - [Category I - Coordination Manipulation](#category-i---coordination-manipulation-ce3-070--ce3-074-ce3-083--ce3-087)
  - [Category J - Disinformation about the Bug Itself](#category-j---disinformation-about-the-bug-itself-ce3-075--ce3-078)
...
**2. Existing partial taxonomies are adjacent but distinct.** The Bugcrowd Vulnerability Rating Taxonomy (open-sourced 2017, currently v1.18) classifies *vulnerabilities* by priority, not vendor responses; HackerOne's report-state model has only five close states (Resolved / Informative / Not Applicable / Duplicate / Spam), which compresses a much richer space of dismissal patterns into opaque buckets; disclose.io's `research-threats` repo (continuing attrition.org's "Legal Threats Against Security Researchers" list) catalogs *individual incidents* without abstracting them into named patterns. CE3 fills the gap between incident archives and platform close-codes.
...
CE3 has a clear niche. The closest analog is CERT/CC's "Troubleshooting CVD" chapter, but it is prose, not an ID-stable enumeration, and it focuses on *coordination problems* rather than on *vendor evasion patterns* specifically. CE3 explicitly cites VRT, HackerOne close-codes, and CERT/CC and positions itself as the missing "vendor-side" complement.
...
Related: CE3-006 (Defense-in-Depth-As-Excuse)
...
**CE3-003 | Network-Segmentation-Handwave**
...
Related: CE3-004 (Behind-the-VPN), CE3-017 (Air-Gap-Assumed)

---

**CE3-004 | Behind-the-VPN**
...
Related: CE3-002 (Region-Blocked-So-Safe), CE3-003 (Network-Segmentation-Handwave), CE3-038 (Test/Staging-So-Doesn't-Matter)

---

**CE3-005 | Authenticated-Endpoint-Therefore-Safe**
...
Related: CE3-012 (Insider-Only-So-Doesn't-Count), CE3-014 (Trusted-User-Required)

---

**CE3-006 | Defense-in-Depth-As-Excuse**
...
Critiqued in Bugcrowd VRT guidance against treating WAF coverage as an equivalent fix; see also CE3-001.

Related: CE3-001 (WAF-Will-Catch-It), CE3-008 (We-Have-Logging/Detection), CE3-009 (EDR-Will-Catch-the-Payload)

---

**CE3-007 | Rate-Limiting-Suffices**
...
Related: CE3-005 (Authenticated-Endpoint-Therefore-Safe)

---

**CE3-008 | We-Have-Logging/Detection**
...
Related: CE3-006 (Defense-in-Depth-As-Excuse), CE3-009 (EDR-Will-Catch-the-Payload)

---

**CE3-009 | EDR-Will-Catch-the-Payload**
...
Related: CE3-006 (Defense-in-Depth-As-Excuse), CE3-008 (We-Have-Logging/Detection), CE3-010 (Compiler-Mitigations-Handle-It)

---

**CE3-010 | Compiler-Mitigations-Handle-It**
...
Related: CE3-009 (EDR-Will-Catch-the-Payload), CE3-025 (Theoretical-Only)

---

### Category B - Threat-Model Gaming (CE3-011 … CE3-019)

*Re-defining the threat model to write the vulnerability out of scope.*

---

**CE3-011 | Not-In-Our-Threat-Model**
...
Related: CE3-015 (Customer-Misconfiguration), CE3-047 (Disingenuous-Out-of-Scope)

---

**CE3-012 | Insider-Only-So-Doesn't-Count**
...
Related: CE3-005 (Authenticated-Endpoint-Therefore-Safe), CE3-014 (Trusted-User-Required)

---

**CE3-013 | Physical-Access-Game-Over**
...
Related: CE3-011 (Not-In-Our-Threat-Model), CE3-017 (Air-Gap-Assumed)

---

**CE3-014 | Trusted-User-Required**
...
Related: CE3-005 (Authenticated-Endpoint-Therefore-Safe), CE3-012 (Insider-Only-So-Doesn't-Count)

---

**CE3-015 | Customer-Misconfiguration**
...
Related: CE3-011 (Not-In-Our-Threat-Model), CE3-016 (Won't-Fix-You-Misuse-Our-Product)

---

**CE3-016 | Won't-Fix-You-Misuse-Our-Product**
...
Related: CE3-015 (Customer-Misconfiguration), CE3-032 (Customer-Demanded-It)

---

**CE3-017 | Air-Gap-Assumed**
...
Related: CE3-003 (Network-Segmentation-Handwave), CE3-013 (Physical-Access-Game-Over)

---

**CE3-018 | Threat-Actor-Wouldn't-Bother**
...
Related: CE3-025 (Theoretical-Only), CE3-026 (No-Real-Life-Exploitation-Observed)

---

**CE3-019 | Single-Tenant-Therefore-Safe**
...
A recurring pattern in cloud-platform bug bounty disclosures; tenant-isolation bypass bugs frequently get reclassified as "no customer impact" when the researcher (correctly) stopped short of accessing real customer data. See also CE3-069 (Demanding-Illegal-Proof).

Related: CE3-069 (Demanding-Illegal-Proof), CE3-081 (Demand-Customer-Data-As-Proof)

---

### Category C - Severity Manipulation / CVSS Gaming (CE3-020 … CE3-028)

*Distorting the severity calculus to drop the bug below the action threshold.*

---

**CE3-020 | CVSS-AV-Downgrade**
...
Related: CE3-004 (Behind-the-VPN), CE3-021 (CVSS-PR-Inflation)

---

**CE3-021 | CVSS-PR-Inflation**
...
Related: CE3-014 (Trusted-User-Required), CE3-020 (CVSS-AV-Downgrade)

---

**CE3-022 | CVSS-UI-Inflation**
...
Related: CE3-020 (CVSS-AV-Downgrade), CE3-023 (CVSS-Scope-Reduction)

---

**CE3-023 | CVSS-Scope-Reduction**
...
Related: CE3-022 (CVSS-UI-Inflation), CE3-024 (CVSS-Confidentiality-Lowballing)

---

**CE3-024 | CVSS-Confidentiality-Lowballing**
...
Related: CE3-023 (CVSS-Scope-Reduction), CE3-027 (Informational-Reclassification)

---

**CE3-025 | Theoretical-Only**
...
Related: CE3-018 (Threat-Actor-Wouldn't-Bother), CE3-026 (No-Real-Life-Exploitation-Observed)

---

**CE3-026 | No-Real-Life-Exploitation-Observed**
...
Related: CE3-025 (Theoretical-Only), CE3-018 (Threat-Actor-Wouldn't-Bother)

---

**CE3-027 | Informational-Reclassification**
...
Related: CE3-050 (We-Already-Knew), CE3-052 (Bounty-Haggling)

---

**CE3-028 | Self-Inflicted-Only**
...
Related: CE3-025 (Theoretical-Only), CE3-006 (Defense-in-Depth-As-Excuse)

---

### Category D - "By Design" / Expected Behavior (CE3-029 … CE3-035)

*Asserting intended design to avoid acknowledging a security flaw.*

---

**CE3-029 | Working-As-Intended**
...
Related: CE3-030 (Documented-Behavior), CE3-031 (It's-A-Feature-Not-A-Bug)

---

**CE3-030 | Documented-Behavior**
...
Related: CE3-029 (Working-As-Intended), CE3-034 (Spec-Compliance-Shield)

---

**CE3-031 | It's-A-Feature-Not-A-Bug**
...
Related: CE3-029 (Working-As-Intended), CE3-032 (Customer-Demanded-It)

---

**CE3-032 | Customer-Demanded-It**
...
Related: CE3-016 (Won't-Fix-You-Misuse-Our-Product), CE3-031 (It's-A-Feature-Not-A-Bug)

---

**CE3-033 | Industry-Standard-Behavior**
...
**CE3-034 | Spec-Compliance-Shield**
...
Related: CE3-030 (Documented-Behavior), CE3-033 (Industry-Standard-Behavior)

---

**CE3-035 | Won't-Fix-Inherited**
...
Related: CE3-040 (Third-Party-Vendor-Problem), CE3-041 (Acquired-Company-Code), CE3-076 ("Not-Our-Code")

---

### Category E - Asset Dismissal (CE3-036 … CE3-042)

*Denying responsibility for a vulnerable asset by contesting its scope or status.*

---

**CE3-036 | Decommissioned-Asset-Claim**
...
Related: CE3-037 (Legacy-System-Therefore-Out-of-Scope), CE3-042 (Deprecated-Endpoint)

---

**CE3-037 | Legacy-System-Therefore-Out-of-Scope**
...
Related: CE3-036 (Decommissioned-Asset-Claim), CE3-039 (Old-Version-No-Longer-Supported)

---

**CE3-038 | Test/Staging-So-Doesn't-Matter**
...
Related: CE3-004 (Behind-the-VPN), CE3-036 (Decommissioned-Asset-Claim)

---

**CE3-039 | Old-Version-No-Longer-Supported**
...
Related: CE3-036 (Decommissioned-Asset-Claim), CE3-037 (Legacy-System-Therefore-Out-of-Scope), CE3-071 (Quick-Fix-Marked-As-Fix)

---

**CE3-040 | Third-Party-Vendor-Problem**
...
Related: CE3-035 (Won't-Fix-Inherited), CE3-041 (Acquired-Company-Code), CE3-076 ("Not-Our-Code")

---

**CE3-041 | Acquired-Company-Code**
...
Related: CE3-035 (Won't-Fix-Inherited), CE3-040 (Third-Party-Vendor-Problem)

---

**CE3-042 | Deprecated-Endpoint**
...
Related: CE3-036 (Decommissioned-Asset-Claim), CE3-037 (Legacy-System-Therefore-Out-of-Scope)

---

### Category F - Process Deflection (CE3-043 … CE3-053, CE3-079 … CE3-082)

*Using administrative, procedural, or platform mechanics to stall, deny, or silence reports.*

---

**CE3-043 | No-Security-Contact**
...
Related: CE3-044 (Black-Hole-Inbox), CE3-074 (Force-Through-Their-Bounty)

---

**CE3-044 | Black-Hole-Inbox**
...
Related: CE3-043 (No-Security-Contact), CE3-045 (Ghosting-Post-Triage)

---

**CE3-045 | Ghosting-Post-Triage**
...
Related: CE3-044 (Black-Hole-Inbox), CE3-046 (Indefinite-Patch-Delay)

---

**CE3-046 | Indefinite-Patch-Delay**
...
Related: CE3-045 (Ghosting-Post-Triage), CE3-070 (Embargo-Stretching)

---

**CE3-047 | Disingenuous-Out-of-Scope**
...
Related: CE3-048 (Retroactive-Scope-Change), CE3-011 (Not-In-Our-Threat-Model)

---

**CE3-048 | Retroactive-Scope-Change**
...
Related: CE3-047 (Disingenuous-Out-of-Scope)

---

**CE3-049 | False-Duplicate**
...
Related: CE3-050 (We-Already-Knew), CE3-075 (Reproduction-Denial)

---

**CE3-050 | We-Already-Knew**
...
Related: CE3-049 (False-Duplicate), CE3-051 (Patch-In-Pipeline)

---

**CE3-051 | Patch-In-Pipeline**
...
Recurring pattern in bounty program disputes; like CE3-050, the claim is unfalsifiable without documentary evidence (ticket, commit, sprint record) predating the report.

Related: CE3-050 (We-Already-Knew), CE3-072 (Silent-Patching-No-Credit)

---

**CE3-052 | Bounty-Haggling**
...
Related: CE3-027 (Informational-Reclassification), CE3-047 (Disingenuous-Out-of-Scope)

---

**CE3-053 | AI-Slop-Accusation-Misapplied**
...
Related: CE3-065 (Methodology-Attack), CE3-075 (Reproduction-Denial)

---

**CE3-079 | No-Support-Contract**
...
Related: CE3-043 (No-Security-Contact), CE3-044 (Black-Hole-Inbox)

---

**CE3-080 | Need-More-Data-Loop**
...
**Does NOT apply when:** The vendor identifies specific, genuinely missing technical details (logs, version info, request traces, environment configuration) the reporter can lawfully provide, and the request is made once with clear triage reasoning. Related to CE3-069 (Demanding-Illegal-Proof) when the demanded data involves PII or customer-confidential material.

Related: CE3-069 (Demanding-Illegal-Proof), CE3-075 (Reproduction-Denial), CE3-081 (Demand-Customer-Data-As-Proof)

---

**CE3-081 | Demand-Customer-Data-As-Proof**
...
Related: CE3-069 (Demanding-Illegal-Proof), CE3-080 (Need-More-Data-Loop), CE3-019 (Single-Tenant-Therefore-Safe)

---

**CE3-082 | Patch-Behind-Paywall**
...
Related: CE3-046 (Indefinite-Patch-Delay), CE3-079 (No-Support-Contract)

---

### Category G - Legal Deflection (CE3-054 … CE3-062)
...
Related: CE3-055 (DMCA-§1201-Threat), CE3-059 (Criminal-Referral), CE3-061 (NDA-Tied-to-Bounty)

---

**CE3-055 | DMCA-§1201-Threat**
...
Related: CE3-054 (CFAA-Threat), CE3-056 (Copyright-Takedown), CE3-058 (Patent-Infringement-Pretext)

---

**CE3-056 | Copyright-Takedown**
...
Related: CE3-055 (DMCA-§1201-Threat), CE3-057 (Trade-Secret/Defamation-Suit)

---

**CE3-057 | Trade-Secret/Defamation-Suit**
...
Related: CE3-054 (CFAA-Threat), CE3-062 (Gag-Clause-Settlement), CE3-068 (Public-Smear/Counter-PR)

---

**CE3-058 | Patent-Infringement-Pretext**
...
Related: CE3-054 (CFAA-Threat), CE3-055 (DMCA-§1201-Threat)

---

**CE3-059 | Criminal-Referral**
...
Related: CE3-054 (CFAA-Threat), CE3-063 ("Hacker"-Labeling), CE3-068 (Public-Smear/Counter-PR)

---

**CE3-060 | Cease-and-Desist**
...
Related: CE3-054 (CFAA-Threat), CE3-057 (Trade-Secret/Defamation-Suit)

---

**CE3-061 | NDA-Tied-to-Bounty**
...
Related: CE3-062 (Gag-Clause-Settlement), CE3-074 (Force-Through-Their-Bounty)

---

**CE3-062 | Gag-Clause-Settlement**
...
Related: CE3-057 (Trade-Secret/Defamation-Suit), CE3-061 (NDA-Tied-to-Bounty)

---

### Category H - Shoot-the-Messenger (CE3-063 … CE3-069)

*Attacking the reporter's character, motives, identity, or methods to delegitimize the finding.*

---

**CE3-063 | "Hacker"-Labeling**
...
Related: CE3-059 (Criminal-Referral), CE3-068 (Public-Smear/Counter-PR)

---

**CE3-064 | Bad-Faith-Attribution**
...
Related: CE3-063 ("Hacker"-Labeling), CE3-065 (Methodology-Attack)

---

**CE3-065 | Methodology-Attack**
...
Voatz's public response to the MIT research combined CE3-039 (Old-Version), CE3-064 (Bad-Faith-Attribution), and CE3-065: wrong app version, researcher identity/affiliation, and failure to use the Bugcrowd program were all cited to question findings that Trail of Bits subsequently confirmed.

Related: CE3-064 (Bad-Faith-Attribution), CE3-066 (Identity/Affiliation-Demand)

---

**CE3-066 | Identity/Affiliation-Demand**
...
Related: CE3-065 (Methodology-Attack), CE3-067 (Employer-Pressure)

---

**CE3-067 | Employer-Pressure**
...
Related: CE3-066 (Identity/Affiliation-Demand), CE3-068 (Public-Smear/Counter-PR)

---

**CE3-068 | Public-Smear/Counter-PR**
...
Related: CE3-063 ("Hacker"-Labeling), CE3-064 (Bad-Faith-Attribution), CE3-059 (Criminal-Referral)

---

**CE3-069 | Demanding-Illegal-Proof**
...
EFF's Coders' Rights FAQ flags this as a recurring trap in vendor responses: the demand converts good-faith research into a crime if the researcher complies, and is used as a pretext to dismiss the report if they refuse. Related to CE3-081 (Demand-Customer-Data-As-Proof) when the framing is administrative rather than explicit.

Related: CE3-019 (Single-Tenant-Therefore-Safe), CE3-080 (Need-More-Data-Loop), CE3-081 (Demand-Customer-Data-As-Proof)

---

### Category I - Coordination Manipulation (CE3-070 … CE3-074, CE3-083 … CE3-087)

*Distorting the coordinated disclosure process to the vendor's advantage.*

---

**CE3-070 | Embargo-Stretching**
...
Related: CE3-046 (Indefinite-Patch-Delay), CE3-071 (Quick-Fix-Marked-As-Fix)

---

**CE3-071 | Quick-Fix-Marked-As-Fix**
...
Related: CE3-070 (Embargo-Stretching), CE3-072 (Silent-Patching-No-Credit), CE3-039 (Old-Version-No-Longer-Supported)

---

**CE3-072 | Silent-Patching-No-Credit**
...
Related: CE3-071 (Quick-Fix-Marked-As-Fix), CE3-051 (Patch-In-Pipeline)

---

**CE3-073 | Branded-Vuln-Hijack**
...
Related: CE3-070 (Embargo-Stretching), CE3-072 (Silent-Patching-No-Credit)

---

**CE3-074 | Force-Through-Their-Bounty**
...
Related: CE3-061 (NDA-Tied-to-Bounty), CE3-043 (No-Security-Contact)

---

**CE3-083 | Coordinated-Disclosure-Refusal**
...
Related: CE3-070 (Embargo-Stretching), CE3-084 (Downstream-Notification-Blockade), CE3-085 (Unilateral-Process-Insistence)

---

**CE3-084 | Downstream-Notification-Blockade**
...
Related: CE3-083 (Coordinated-Disclosure-Refusal), CE3-086 (Coordinator-Bypass), CE3-087 (Multi-Party-Free-Riding)

---

**CE3-085 | Unilateral-Process-Insistence**
...
Related: CE3-083 (Coordinated-Disclosure-Refusal), CE3-086 (Coordinator-Bypass)

---

**CE3-086 | Coordinator-Bypass**
...
Related: CE3-083 (Coordinated-Disclosure-Refusal), CE3-085 (Unilateral-Process-Insistence)

---

**CE3-087 | Multi-Party-Free-Riding**
...
Related: CE3-083 (Coordinated-Disclosure-Refusal), CE3-084 (Downstream-Notification-Blockade), CE3-035 (Won't-Fix-Inherited)

---

### Category J - Disinformation about the Bug Itself (CE3-075 … CE3-078)

*Making false or misleading factual claims about the vulnerability's nature, reproducibility, or severity.*

---

**CE3-075 | Reproduction-Denial**
...
Closely paired with CE3-049 (False-Duplicate) as a low-effort close mechanism; unlike False-Duplicate it requires no fabricated prior report. Documented across researcher survey data as one of the most commonly reported forms of non-engagement.
...
Related: CE3-049 (False-Duplicate), CE3-080 (Need-More-Data-Loop), CE3-053 (AI-Slop-Accusation-Misapplied)

---

**CE3-076 | "Not-Our-Code"**
...
Distinct from CE3-035 (Won't-Fix-Inherited) in that CE3-076 specifically misdescribes where the bug lies - the vendor's integration is the actual vulnerable code, not the upstream library itself.

Related: CE3-035 (Won't-Fix-Inherited), CE3-040 (Third-Party-Vendor-Problem)

---

**CE3-077 | Number-Inflation-of-Steps**
...
**CE3-078 | Public-Statement-Contradicting-Internal-Triage**
...
Related: CE3-068 (Public-Smear/Counter-PR), CE3-072 (Silent-Patching-No-Credit)

---

## Structural Conventions

1. **Stable IDs.** CE3-001 through CE3-087 (v0.1) should never be reused; deprecations get an explicit `DEPRECATED` flag, mirroring CWE's policy.
...
4. **Optional fields:** Counter-evidence checklist - what would make a given dismissal *legitimate* rather than evasive. Critical for fairness and to prevent CE3 from being used as a one-sided weapon. v0.1 ships this field for the most-abusable entries; all entries should have it by v1.0.
...
6. **Explicit non-goals.** CE3 does *not* score severity (use VRT/CVSS), does *not* arbitrate individual disputes (use HackerOne/Bugcrowd mediation, CERT/CC), and does *not* make legal claims (defer to EFF / disclose.io).
